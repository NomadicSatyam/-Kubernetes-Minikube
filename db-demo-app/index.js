...
const mydatabaseName = process.env.MONGO_DB || 'mydatabase';

mongoose.connect(`mongodb://${mongoHost}:${mongoPort}/${mydatabaseName}`, {
    useNewUrlParser: true,
    useUnifiedTopology: true,
});

// // Connect to MongoDB
// mongoose.connect('mongodb://localhost:27017/mybaseName', {
//     useNewUrlParser: true,
//     useUnifiedTopology: true,
// });
